					...
					if($_FILES['file']['tmp_name'] != ''){
						...
						if($fileExt == 'png' || $fileExt == 'jpg' ||$fileExt == 'jpeg'){
							...
							if($size <= 300){
								...
								$_SESSION['img'] = $uniqid;
								move_uploaded_file($file['tmp_name'],'C:\xampp\htdocs\Projetos_Estudos/02-Cursos_danki/02-CursoDesenvolvimentoWEBCompleto2.0/Projeto-Pratico-Rede_Social/uploads/'.$uniqid);
